...
### 3.3 Node Priority for Bandwidth Allocation
...
- Critical alerts override priority (any node can immediately transmit alert)

### 3.4 UWB Integration (Optional)
...
## 5. MCU Co-Processor Pattern (Variants B, C, E)
...
## 6. Hardware Interfaces Summary

### 6.1 External Connectivity (Belt Node Only)
...
| Interface | Purpose |
|---|---|
| WiFi antenna | U.FL connector for external antenna |
| Cellular antenna | U.FL connector for external antenna |
| BLE antenna | PCB trace or chip antenna |
| UWB antenna (optional) | PCB trace or chip antenna |

---

## 7. Downward-Facing mmWave Radar
...
|--------|-----------|----------|-------|-------|
| TI IWR6843AOP | 60 GHz | Antenna-on-package, FMCW, good angular resolution | 200-400 mW | Preferred for production |
...
## 8. IMU (Torso Reference — Critical)

### Why This IMU Is Critical
...
### 9.3 Power Budget by Operating Mode
...
### 9.4 Power Management Strategies
...
### 10.2 Thermal Design Requirements
...
### 10.3 Thermal Mitigation Strategies
...
**Strategy 3: Time-division multiplexing**
...
Belt Node Enclosure (Cross-Section)
    ...
    │   │              PCB / Electronics                     │   │
    │   │                                                   │   │
    │   │   [BLE Antenna]              [BLE Antenna]        │   │  ← Interior
...
## 14. Form Factor Options

### 14.1 Belt Buckle Replacement
...
### 14.3 Extended Belt Pack (Variant E)
...
### 15.1 All Variants — Mandatory Tests
...
### 15.2 Linux SoM Variants — Additional Tests
...
### 15.3 Cellular Module Tests (If Installed)
...
### 15.4 Hot-Swap Tests (Variant E Only)

18. Battery swap while running — system continues operation on remaining battery
19. Swap detection — firmware correctly reports which bay is active
20. Charge while operating — both bays charge while system runs
